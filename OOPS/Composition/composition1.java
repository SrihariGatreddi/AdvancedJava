...
// the entity personal computer cant be created without the entities keyboard and mouse,
// so one entity cant be existed without the other entity,
...
// now the personal computer is manufactured using the key board and mouse.
